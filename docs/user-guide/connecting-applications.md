...
This guide uses a simple nginx server to demonstrate proof of concept. The same principles are embodied in a more complete [Jenkins CI application](http://blog.gertisdemo.github.io/2015/07/strong-simple-ssl-for-kubernetes.html).
...
$ kubectl get secrets
NAME                  TYPE                                  DATA
default-token-il9rc   gertisdemo.github.io/service-account-token   1

...
[`spec.volumes`](http://gertisdemo.github.io/kubernetes/third_party/swagger-ui/#!/v1/createPod)
field) and where to mount those into containers(the
[`spec.containers.volumeMounts`](http://gertisdemo.github.io/kubernetes/third_party/swagger-ui/#!/v1/createPod)
field).
